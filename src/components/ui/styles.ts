export const styles = {
  ...
  uploadBox: {
    ...
    inner: "relative flex flex-col items-center gap-6 rounded-xl border-2 border-dashed border-white/20 bg-white/[0.03] p-8 text-center hover:border-white/30",
    iconContainer: "flex items-center justify-center w-14 h-14 rounded-full bg-white/[0.08] text-white/70",
    ...
    uploadButton: "px-5 py-2 text-sm font-medium text-white/90 bg-white/[0.08] rounded-lg border border-white/20 hover:bg-white/[0.12] hover:border-white/30",
  ...
  colorPicker: "w-full h-10 rounded-lg cursor-pointer bg-transparent border border-white/20",
  optionsSlider: "w-full h-2 bg-accent/10 rounded-lg appearance-none cursor-pointer accent-primary",

  // Option buttons
  optionButton: {
    base: "w-full px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200",
    selected: "bg-accent/20 text-white border border-accent/40",
    unselected: "bg-white/[0.08] text-white/70 border border-white/20 hover:bg-white/[0.12] hover:border-white/30",
  },

  // Buttons
  buttonsContainer: "flex flex-wrap gap-4 justify-center",
  primaryButton: "px-6 py-2 bg-primary text-primary-foreground rounded-lg font-medium shadow-lg transition-all duration-200 hover:opacity-90 active:scale-[0.98]",
  secondaryButton: "px-6 py-2 bg-accent/10 text-foreground rounded-lg font-medium border border-accent/20 transition-all duration-200 hover:bg-accent/20 hover:border-accent/30 active:scale-[0.98]",
